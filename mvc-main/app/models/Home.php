...
class Home extends Database {
	...
	public function upload(){
        ...
        $image.check(); #Tjek billedets filformat (Ved ikke rigtig om det her er ulovligt.)
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) 
        {
            ...
            $sql = "INSERT INTO images (username, image, imgheader, imgdescription)
                    VALUES (:username, :fileToUpload, :imgheader, :imgdescription);";
        ...
        return $image_id; #Returnere image id 
	}
	...
	public function get_images () {
		$sql = "SELECT image_id ,image, header, description FROM images";
	...
	public function get_image ($image_id) {
		$sql = "SELECT image_id, image, header, description FROM images WHERE image_id = :image_id";
